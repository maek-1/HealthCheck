...
from PyQt5.QtWidgets import QApplication, QWidget,QLabel,QPushButton, QButtonGroup, QRadioButton, QHBoxLayout, QMessageBox, QVBoxLayout, QLineEdit
from instr import *
...
class TestWin(QWidget):
    ...
    def next_click(self):
        ...
        if not age.isdigit() or int(age) < 7:
            QMessageBox.warning(self, 'Ошибка', 'Введите возраст')
            return
        if not test1.isdigit():
            QMessageBox.warning(self, 'Ошибка', 'Введите пульс')
            return 
